...
fn get_builtin_docs(name: &str) -> Option<String> {
    let docs = match name {
        ...
        "http_post" => "Performs an HTTP POST request.\n\n```\nhttp_post(url: String, body: String|Hash): String\n```",
        "http_get_json" => "Performs an HTTP GET request and parses JSON response.\n\n```\nhttp_get_json(url: String): Any\n```",
        "http_post_json" => "Performs an HTTP POST request with JSON body.\n\n```\nhttp_post_json(url: String, body: Any): Any\n```",
