...
return [
    ...
    */
    ...
    // storage/ is a host-owned bind mount; keep runtime state on the container's
    // own writable filesystem instead. Config is cached, so env() is not consulted.
    'state_file' => env('OCTANE_STATE_FILE', '/tmp/octane-server-state.json'),
