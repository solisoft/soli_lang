...
(function(global) {
    ...
    class SoliLiveView {
         ...
         */
        applyRender(html) {
            // Find the root element (either from data-live-root or body)
            const root = document.querySelector('[data-live-root]') || document.body;
            root.innerHTML = html;
        ...
        /**
         * Bind click and form submission handlers
         */
        bindEvents() {
