...
get("/docs/core-concepts/forms", "docs#core_concepts_forms")
get("/docs/core-concepts/websockets", "docs#core_concepts_websockets")
get("/docs/core-concepts/streaming", "docs#core_concepts_streaming")
get("/docs/core-concepts/liveview", "docs#core_concepts_liveview")
get("/docs/core-concepts/eui", "docs#core_concepts_eui")
get("/docs/eui/overview", "docs#eui_overview")
get("/docs/eui/styling", "docs#eui_styling")
get("/docs/eui/events", "docs#eui_events")
get("/docs/eui/assets", "docs#eui_assets")
get("/docs/eui/widgets-layout", "docs#eui_widgets_layout")
get("/docs/eui/widgets-input", "docs#eui_widgets_input")
get("/docs/eui/widgets-data", "docs#eui_widgets_data")
get("/docs/eui/widgets-internals", "docs#eui_widgets_internals")
...
get("/docs/database/postgres", "docs#database_postgres")
get("/docs/database/mysql", "docs#database_mysql")
get("/docs/database/sqlite", "docs#database_sqlite")
...
get("/docs/native/notifications", "docs#native_notifications")
get("/docs/native/camera", "docs#native_camera")
get("/docs/native/scanning", "docs#native_scanning")
get("/docs/native/geolocation", "docs#native_geolocation")
get("/docs/native/motion-sensors", "docs#native_motion_sensors")
get("/docs/native/device", "docs#native_device")
get("/docs/native/deep-links", "docs#native_deep_links")
get("/docs/native/push-apple", "docs#native_push_apple")
get("/docs/native/push-android", "docs#native_push_android")
get("/docs/native/devices", "docs#native_devices")
get("/docs/native/clients", "docs#native_clients")
get("/docs/native/offline", "docs#native_offline")
get("/docs/native/platform-limits", "docs#native_platform_limits")
...
get("/docs/language/enums", "docs#language_enums")
...
get("/docs/builtins/paseto", "docs#builtins_paseto")
get("/docs/builtins/vapid", "docs#builtins_vapid")
get("/docs/builtins/pdf", "docs#builtins_pdf")
get("/docs/builtins/pdf-templates", "docs#pdf_templates")
get("/docs/builtins/pdf-editor", "docs#pdf_editor")
get("/docs/builtins/pdf-studio", "docs#pdf_studio")
post("/docs/builtins/pdf-studio/layout", "docs#pdf_studio_layout")
get("/docs/builtins/pdf-playground", "docs#pdf_playground")
post("/docs/builtins/pdf-playground/render", "docs#pdf_playground_render")
...
get("/docs/builtins/url", "docs#builtins_url")
get("/docs/builtins/logger", "docs#builtins_logger")
get("/docs/builtins/resilience", "docs#builtins_resilience")
get("/docs/builtins/toml-yaml", "docs#builtins_toml_yaml")
get("/docs/builtins/semaphore", "docs#builtins_semaphore")
get("/docs/builtins/money", "docs#builtins_money")
...
get("/docs/builtins/pop3", "docs#builtins_pop3")
get("/docs/builtins/imap", "docs#builtins_imap")
get("/docs/builtins/mailer", "docs#builtins_mailer")
