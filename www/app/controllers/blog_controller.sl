...
fn get_blog_posts()
    ...
    let blog_info = [
        ...
        {"slug": "liveview", "file": "docs/blog/liveview.md", "desc": "Build real-time server-rendered UIs with Soli LiveView. A practical, production-grade team presence + activity feed widget with ticks, simulated remote activity, and zero client-side JavaScript.", "tag": "Tutorial", "image": "liveview-activity.jpg"},
