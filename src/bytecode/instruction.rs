...
pub enum OpCode {
    ...
    GreaterEqual,
    /// Range: a..b (creates array from a to b-1)
    Range,
...
impl OpCode {
    ...
    pub fn from_u8(byte: u8) -> Option<OpCode> {
        match byte {
            ...
            26 => Some(OpCode::Range),
            27 => Some(OpCode::Not),
            28 => Some(OpCode::Jump),
            29 => Some(OpCode::JumpIfFalse),
            30 => Some(OpCode::JumpIfTrue),
            31 => Some(OpCode::JumpIfFalseNoPop),
            32 => Some(OpCode::JumpIfTrueNoPop),
            33 => Some(OpCode::Loop),
            34 => Some(OpCode::Call),
            35 => Some(OpCode::Invoke),
            36 => Some(OpCode::SuperInvoke),
            37 => Some(OpCode::Return),
            38 => Some(OpCode::Closure),
            39 => Some(OpCode::LoadDefault),
            40 => Some(OpCode::Class),
            41 => Some(OpCode::Inherit),
            42 => Some(OpCode::Method),
            43 => Some(OpCode::StaticMethod),
            44 => Some(OpCode::GetProperty),
            45 => Some(OpCode::SetProperty),
            46 => Some(OpCode::GetThis),
            47 => Some(OpCode::GetSuper),
            48 => Some(OpCode::New),
            49 => Some(OpCode::BuildArray),
            50 => Some(OpCode::BuildHash),
            51 => Some(OpCode::Index),
            52 => Some(OpCode::IndexSet),
            53 => Some(OpCode::SpreadArray),
            54 => Some(OpCode::SpreadHash),
            55 => Some(OpCode::GetIterator),
            56 => Some(OpCode::IteratorNext),
            57 => Some(OpCode::NativeCall),
            58 => Some(OpCode::TypeCheck),
            59 => Some(OpCode::ArrayLen),
            60 => Some(OpCode::GetPropertyStr),
            61 => Some(OpCode::GetFieldStr),
            62 => Some(OpCode::BuildArrayFromStack),
            63 => Some(OpCode::BuildHashFromStack),
            64 => Some(OpCode::StoreBinding),
            65 => Some(OpCode::Print),
            66 => Some(OpCode::Try),
            67 => Some(OpCode::TryEnd),
            68 => Some(OpCode::Throw),
            69 => Some(OpCode::Rethrow),
            70 => Some(OpCode::PopTry),
            _ => None,
        }
    }
}
